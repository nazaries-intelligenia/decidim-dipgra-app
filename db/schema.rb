...
ActiveRecord::Schema.define(version: 20_190_225_144_527) do
  ...
  create_table 'decidim_budgets_orders', id: :serial, force: :cascade do |t|
    ...
    t.index %w[decidim_user_id decidim_component_id], name: 'decidim_budgets_order_user_component_unique', unique: true
  ...
  create_table 'decidim_content_blocks', force: :cascade do |t|
    ...
    t.index %w[decidim_organization_id scope manifest_name], name: 'idx_dcdm_content_blocks_uniq_org_id_scope_manifest_name', unique: true
  ...
  create_table 'decidim_continuity_badge_statuses', force: :cascade do |t|
    ...
    t.index %w[subject_type subject_id], name: 'decidim_continuity_statuses_subject'
  end
  ...
  create_table 'decidim_proposals_proposal_endorsements', force: :cascade do |t|
    ...
    t.index %w[decidim_author_id decidim_author_type], name: 'index_decidim_proposals_proposal_endorsements_on_decidim_author'
